...
public abstract class DOMDigestMethod extends BaseStructure implements DigestMethod {
	...
	static final String SHA224 = "http://www.w3.org/2001/04/xmldsig-more#sha224"; // see RFC 4051
	static final String SHA384 = "http://www.w3.org/2001/04/xmldsig-more#sha384"; // see RFC 4051
	static final String WHIRLPOOL = "http://www.w3.org/2007/05/xmldsig-more#whirlpool"; // see RFC 6931
	static final String SHA3_224 = "http://www.w3.org/2007/05/xmldsig-more#sha3-224"; // see RFC 6931
	...
	static final String SM3_GmSSL = Constants.GMAlgorithmsSpecNS  + "sm3_ssl";
	...
	/**
	 * Checks if the specified parameters are valid for this algorithm. By default,
	 * this method throws an exception if parameters are specified since most
	 * DigestMethod algorithms do not have parameters. Subclasses should override it
	 ...
	 * <code>Element</code>. By default, this method throws an exception since most
	 * DigestMethod algorithms do not have parameters. Subclasses should override it
	 * if they have parameters.
	 *
	 * @param paramsElem
	...
	/**
	 * This method invokes the abstract {@link #marshalParams marshalParams} method
	 * to marshal any algorithm-specific parameters.
	 */
	...
	/**
	 * Marshals the algorithm-specific parameters to an Element and appends it to
	 * the specified parent element. By default, this method throws an exception
	 * since most DigestMethod algorithms do not have parameters. Subclasses should
