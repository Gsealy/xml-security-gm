...
public final class DOMReference extends DOMStructure implements Reference, DOMURIReference {
  ...
  private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(DOMReference.class);
...
//  private GmSSL gmssl;
  ...
  public DOMReference(String uri, String type, DigestMethod dm,
      List<? extends Transform> transforms, String id, Provider provider) {
  ...
  public DOMReference(String uri, String type, DigestMethod dm,
      List<? extends Transform> appliedTransforms, Data result,
      List<? extends Transform> transforms, String id, byte[] digestValue, Provider provider) {
    if (dm == null) {
  ...
  public DOMReference(Element refElem, XMLCryptoContext context, Provider provider)
    ...
    if (nextSibling.getLocalName().equals("Transforms")
      ...
      Element transformElem =
          DOMUtils.getFirstChildElement(nextSibling, "Transform", XMLSignature.XMLNS);
    ...
    if (!nextSibling.getLocalName().equals("DigestMethod")
      ...
      throw new MarshalException(
          "Invalid element name: " + nextSibling.getLocalName() + ", expected DigestMethod");
    }
    ...
    if (secVal && MessageDigestAlgorithm.ALGO_ID_DIGEST_NOT_RECOMMENDED_MD5
        .equals(digestMethodAlgorithm)) {
      throw new MarshalException("It is forbidden to use algorithm " + digestMethod
  ...
  public byte[] getCalculatedDigestValue() {
    return calcDigestValue == null ? null : calcDigestValue.clone();
  }
