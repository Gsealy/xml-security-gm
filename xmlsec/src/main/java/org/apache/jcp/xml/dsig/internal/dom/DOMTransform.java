...
public class DOMTransform extends BaseStructure implements Transform {
  ...
  /**
   * Creates a <code>DOMTransform</code> from an element. It unmarshals any algorithm-specific input
   * parameters.
   *
  ...
  public void marshal(XmlWriter xwriter, String dsPrefix, XMLCryptoContext context)
    ...
    String localName =
        "Transforms".equals(parentLocalName) ? "Transform" : "CanonicalizationMethod";
  ...
  /**
   * Transforms the specified data using the underlying transform algorithm. This method invokes the
   * {@link #marshal marshal} method and passes it the specified <code>DOMSignContext</code> before
   ...
   * @throws NullPointerException if <code>data</code> or <code>context</code> is <code>null</code>
   * @throws XMLSignatureException if an unexpected error occurs while executing the transform
   */
