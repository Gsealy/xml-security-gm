...
/**
 * Implements the <CODE>http://127.0.0.1/2006/12/xml-c14n11</CODE>
 * (C14N 1.1) transform.
 * @author Gsealy
 */
public class TransformC14N11_GM extends TransformC14N {
    ...
    protected String engineGetURI() {
        return Transforms.TRANSFORM_C14N11_OMIT_COMMENTS_GM;
    }
    ...
    protected Canonicalizer20010315 getCanonicalizer() {
        return new Canonicalizer11_OmitCommentsGM();
    }
