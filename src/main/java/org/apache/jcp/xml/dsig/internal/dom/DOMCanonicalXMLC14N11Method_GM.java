 ...
 * @author Gsealy
 */
public final class DOMCanonicalXMLC14N11Method_GM extends ApacheCanonicalizer {

    public static final String C14N_11_GM = "http://127.0.0.1/2006/12/xml-c14n11";
    public static final String C14N_11_WITH_COMMENTS_GM
    ...
    public Data transform(Data data, XMLCryptoContext xc)
        ...
        if (data instanceof DOMSubTreeData) {
            ...
            if (subTree.excludeComments()) {
                try {
                    canonicalizer = Canonicalizer.getInstance(C14N_11_GM);
                } catch (InvalidCanonicalizerException ice) {
                    throw new TransformException
                        ("Couldn't find Canonicalizer for: " +
                         C14N_11_GM + ": " + ice.getMessage(), ice);
                }
            }
        }
